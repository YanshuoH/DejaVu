...
exports.fetchEvents = function(events, str) {
    ...
    if (events_arr.indexOf("OR") > -1) {
        events_arr.slice(events_arr.indexOf("OR"), 1);
        substr = substr.concat(events_arr);
        for (var index=0; index<substr.length; index++) {
            if (str.indexOf(substr[index]) > 0) {
                found = true;
            }
        }
    }
...
exports.sample =  [
    [{_id: 1, user: 1, lat : 1}, [{_id: 1, user: 1, lat : 1},{_id: 2, user: 2, lat : 2}, {_id: 3, user: 3, lat : 3}, {_id: 4, user: 4, lat : 4}]],
    [{_id: 2, user: 2, lat : 2}, [{_id: 1, user: 1, lat : 1},{_id: 2, user: 2, lat : 2}, {_id: 3, user: 3, lat : 3}, {_id: 4, user: 4, lat : 4}]],
    [{_id: 3, user: 3, lat : 3}, [{_id: 1, user: 1, lat : 1},{_id: 2, user: 2, lat : 2}, {_id: 3, user: 3, lat : 3}, {_id: 4, user: 4, lat : 4}]],
];