...
Kernel.prototype.makePeriod = function(cases) {
    var step = new Date(this.query_data.end_date).getTime() - new Date(this.query_data.start_date).getTime();
    this.step = step / this.query_data.n;
    if (cases == 0) {
